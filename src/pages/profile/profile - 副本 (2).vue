			...
			<view class="user-info-box">
				...
				>
					...
					<view class="userInfoTBox">
						<view class="userInfoT" v-if="userInfo.memberName" @tap="navTo(userInfo ? '/pages/user/userinfo/userinfo' : 'login')">
							{{userInfo.memberName}}  <text v-if="userInfo.orgId == 46" style="margin-left: 20rpx;">{{userInfo.umsMember.memberNum}}</text>
						</view>
						<view v-else @tap="navTo(userInfo ? '/pages/user/userinfo/userinfo' : 'login')">登錄/註冊</view>
						<!-- <view class="userInfoT">{{userInfo.umsMember.memberNum}}</view> -->
						<view class="userInfoT">{{userInfo.username}}</view>
					</view>
				</view>
