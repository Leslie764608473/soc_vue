<template>
	<view class="login-type">
		<view class="logo">
			<rf-image :preview="false" :src="NowLogo"></rf-image>
		</view>
		<view>
			<button
			...
			<button
				...
				:disabled="btnLoading"
				:class="'text-' + themeColor.name"
				@tap="navTo('/pages/public/registerFirst')"
			>
				立即註冊
			</button>
		</view>
		...
		<rf-protocol-popup
			...
			protocolPath="/pages/set/about/detail?field=protocol_register&title=註冊協議"
			policyPath="/pages/set/about/detail?field=protocol_privacy&title=隱私協議"
		...
		<!-- <view class="footer-protocol">
			...
			></text>
			<text class="content">登錄表示同意</text>
			<!-- 协议地址 --
			<text :class="'text-' + themeColor.name" @tap="handleRfProtocolPopupShow">《{{appName}} 協議》</text>
		</view> -->
		<!-- 底部协议 -->
