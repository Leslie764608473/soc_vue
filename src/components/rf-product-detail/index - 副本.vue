  ...
  <view class="rf-product-detail">
		...
		<view class="detail" v-if="product.name">
			...
			<view class="introduce-section">
				...
				<view class="introduce-second-line">
					<view class="title">
						...
						<text class="sketch">{{ product.price }}</text>
					</view>
					<view class="share">
						<rf-tag
							type="gray"
			...
			<view class="detail-desc">
				...
				<rf-parser :html="product.detailDesc" lazy-load></rf-parser>
				<rf-parser :html="product.detailMobileHtml" lazy-load></rf-parser>
				<rf-parser :html="product.note" lazy-load></rf-parser>
			</view>
			<!-- 底部操作菜单 -->
