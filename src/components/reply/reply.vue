<template>
	<view>
		<view class="article-meta">
			<user-reply v-if="digestData.length > 0" :digest="digestData"></user-reply>
			<view class="article-meta-box">
				<view class="article-header-image">
					<view class="article-header-title">
						<!-- <image class="image" src="../../static/missing-face.png" mode="widthFix"></image> -->
						<image v-if="newData.author.icon" class="image" :src="newData.author.icon" mode="widthFix"></image>
				...
				<view style="width:100%">
					<view class="article-header-content">
						<view class="article-header-title">
							<text>{{newData.author.nickname}}</text>
							<text>
								<!-- <text>11122</text>
								<text style="color:rgb(15,125,247)" class="iconfont icon-zhihuishetuanico_dianzan-18"></text> -->
							</text>
						</view>
					...
					<view class="uni-article__comment-centent">
						{{newData.content}}
						<view class="article-header-info">{{newData.pubDate}}</view>
					</view>
				</view>
			</view>
		</view>
